...
PKGS="neovim vifm zathura htop wayland seatd foot wget doas curl librewolf"  
...
printf "\nInstallation complete now you must compile dwl, somebar and run oh-myzsh manually\n"
