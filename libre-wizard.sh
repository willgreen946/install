...
PKGS="drm-kmod mixertui neofetch wlroots qutebrowser qt5-wayland smartmontools chafa transmission moc lynx cmatrix tor torsocks tor-browser evdev-proto libinput pkgconf neovim vifm zathura zathura-pdf-mupdf tuifeed htop wayland seatd foot wget doas curl librewolf"  
